...
export default function Authenticated({ user, header, children }) {
    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-gray-100 dark:bg-gray-900/80 backdrop-blur-lg z-10">
                        ...
                        <div className="flex justify-between h-16">
                            <div className="flex">
                                <div className="shrink-0 flex items-center">
                                    <Link href="/">
                                        <ApplicationLogo className="block h-9 w-auto fill-current text-gray-800 dark:text-gray-200 rounded-full" />
                                    </Link>
                                </div>
